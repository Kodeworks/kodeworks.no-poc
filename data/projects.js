...
const projects = [
  ...
  },
  {
    ...
    illustration: {
      src: 'https://images.unsplash.com/photo-1520509414578-d9cbf09933a1?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60',
      altText: 'Computer screen with programming code',
  ...
  },
  {
    ...
    illustration: {
      src: 'https://images.unsplash.com/photo-1605647540924-852290f6b0d5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=60',
      altText: 'Cabin with a fjord and high mountains in the background',
      tailwindAspectRatio: 'aspect-w-5 aspect-h-2 md:aspect-w-6 md:aspect-h-2',
    },
    input: [
